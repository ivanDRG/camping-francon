      ...
      <div className="col-12 col-md-4">
        ...
        <ul>
          <li style={{ marginBottom: 7 }}>
            Completamente equipado para 4 persoas, habitación con cama de
            matrimonio, habitación con camas xemelgas, sala de estar, cocina con
            nevera e baño con ducha.
          </li>
          <li style={{ marginBottom: 7 }}>
            Cambio de roupa de cama e toallas semanal
          </li>
          <li style={{ marginBottom: 7 }}>
          ...
          <p style={{ marginTop: 0, marginBottom: 0 }}>
            Xullo e agosto: 7 noites de sábado a sábado
          </p>
          <p style={{ marginTop: 0, marginBottom: 0 }}>
            Xuño e Setembro: 2 noites
          </p>
          <br />
