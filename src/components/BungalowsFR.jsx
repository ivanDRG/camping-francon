    ...
    return (
        <div id="Bungalows" className="galery row noMargin">
            <div className="col-12 col-md-4">
                <h1>Bungalows</h1>
                <ul>
                    <li style={{ marginBottom: 7 }}>Entièrement équipé pour 4 personnes. Chambre avec grand lit, chambre avec 2 lits jumeaux, séjour-cuisine avec réfrigérateur et salle de bain avec douche.</li>
                    <li style={{ marginBottom: 7 }}>Changement hebdomadaire des draps et des serviettes.</li>
                    <li style={{ marginBottom: 7 }}>Bungalows avec parking pour un véhicule</li>
                    ...
                    <p style={{ marginTop: 0, marginBottom: 0 }}>Juillet et Août: 7 nuits du samedi au samedi</p>
                    <p style={{ marginTop: 0, marginBottom: 0 }}>Juin et septembre: 2 nuits</p>
